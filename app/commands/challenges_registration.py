...
class ChallengesRegistration(object):
    ...
    def main(self, month, code):
        ...
        if access_info:
            ...
            if athlete_details:
                if month == "even":
                    query = self.app_constants.QUERY_CHALLENGES_EVEN_UPDATE_VALUES
                else:
                    query = self.app_constants.QUERY_CHALLENGES_ODD_UPDATE_VALUES
            else:
                if month == "even":
                    query = self.app_constants.QUERY_CHALLENGES_EVEN_INSERT_VALUES
                else:
                    query = self.app_constants.QUERY_CHALLENGES_ODD_INSERT_VALUES
